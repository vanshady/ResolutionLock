...
var a = window.crossBrowser_initKeyboardEvent("keypress", {"key": 83, "keyCode":83,"charCode":83,"which":83,"shiftKey": true, "ctrlKey": true, "altKey": true})
document.dispatchEvent(a);
$('.player-video-wrapper').trigger(a);
console.log(a);
...
function simulateClick() {
    ...
    document.getElementById('checkbox').dispatchEvent(event);
